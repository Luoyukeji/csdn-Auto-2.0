 ...
 * @author : qinyingjie
 * @version : 2.2.0
 * @date : 2023/11/8 13:44
 */
public class Signature_Test_03 {
    public static void main(String[] args) {
        String url = "https://bizapi.csdn.net/mp/ask/v1/questions/list?pageNo=1&pageSize=30&communityInfo=1&rewardType=2&type=5&sortBy=1&quick=3";
        String paramUrl = "/mp/ask/v1/questions/list?communityInfo=1&pageNo=1&pageSize=30&quick=3&rewardType=2&sortBy=1&type=5";
